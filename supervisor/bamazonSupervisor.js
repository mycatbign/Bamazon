// Instructions bamazonSupervisor - Supervisor View (Final Level)
// Create a new MySQL table called departments. Your table should
...
// anything from the store, the price of the product multiplied by the quantity 
...
// When a supervisor selects View Product Sales by Department, the app should 
...
// HINT: There may be an NPM package that can log the table to the console. What's
// is it? Good question :)
